...
const { inputValue } = defineProps<Props>();
    ...
    <div>
      ...
      <div>
          ...
          <ul class="flex flex-col border-b border-stroke dark:border-strokedark">
            <li class="border-b border-black">
              <div class="text-sm pl-6 py-3 font-medium lg:text-base dark:text-white flex justify-between">
                <div>Opciones</div>
                <div class="px-4 pr-14" @click.prevent="dropdownOpen = !dropdownOpen">
                  <img src="@/assets/images/bars.png" class="h-4 sm:h-6 color-red" />
                </div>
              </div>
            </li>
          ...
          <table
            ...
            <thead class="text-sm font-normal">
              <tr class="border-b-4 border-black border-opacity-10 text-center">
                ...
                <th scope="col" class="">
                  <div class="px-4 flex gap-2" @click.prevent="SerchBar = !SerchBar">
                    <p>SKU</p>
                  ...
                  <div v-show="SerchBar"
                    ...
                    <ul class="flex flex-col border-b border-stroke dark:border-strokedark">
                      ...
                      <span class="flex justify-end pb-2 pt-1">
                        <p class="text-xs text-white font-normal px-2 w-fit py-1 rounded-xl bg-extradarkGrey">
                          Limpiar
                        </p>
                      </span>
                      <li class="">
        ...
        <div v-if="tooltipVisible"
          class="absolute bg-body dark:bg-white p-2 shadow-lg flex gap-2 h-[55%] rounded-2xl w-[45%]" :style="{
          ...
          <div class="flex gap-2">
            <div class="w-fit my-auto">
              <img class="my-auto h-[90%] rounded-xl" src="@/assets/vueJs/shoes.jpg" alt="" />
            </div>
            <div class="">
              <p class="text-white dark:text-black font-bold text-[12px] lg:text-[20px] leading-tight">
                TENIS ADVANTAGE BASE ADIDAS COURT LIFESTYLE<br /><span
                  class="text-[10px] lg:text-[16px] text-black dark:text-body">Ingresa: 07/09/23 <br />Ventas Totales:
                  113 <br />Stock: 218
                  <br />
                  Varientes: 9</span>
              </p>
        ...
        <nav
          ...
          <span
            class="text-xs sm:text-sm font-bold text-gray-500 dark:text-gray-400 mb-4 md:mb-0 block w-full md:inline md:w-auto">Se
            muestran
            <span class="text-gray-900 dark:text-white font-extrabold">20</span>
            de
            <span class="font-extrabold text-gray-900 dark:text-white">100</span>
            resultados</span>
          <ul class="inline-flex -space-x-px rtl:space-x-reverse text-sm h-6 sm:h-8 text-black dark:text-white">
            <li>
              <a href="#"
                class="flex items-center justify-center px-1 sm:px-3 h-6 sm:h-8 ms-0 leading-tight text-gray-500 border border-gray-300 rounded-s-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white mr-1 dark:border-none dark:bg-extradarkGrey bg-lightGrey border-none"><img
                  src="@/assets/images/doubleLeft.png" class="h-3" /></a>
            </li>
            <li>
              <a href="#"
                class="flex items-center justify-center px-1 sm:px-3 h-6 sm:h-8 leading-tight text-gray-500 border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white mr-1 dark:border-none dark:bg-extradarkGrey bg-lightGrey border-none"><img
                  src="@/assets/images/left.png" /></a>
            </li>
            <li>
              <a href="#"
                class="flex items-center justify-center px-1 sm:px-3 h-6 sm:h-8 leading-tight text-gray-500 border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-none mr-1 dark:bg-extradarkGrey bg-lightGrey border-none">1</a>
            </li>
            <li>
              <a href="#" aria-current="page"
                class="flex items-center justify-center px-1 sm:px-3 h-6 sm:h-8 mr-1 dark:bg-darkGrey border-none bg-extraGrey text-white">2</a>
            </li>
            <li>
              <a href="#"
                class="flex items-center justify-center px-1 sm:px-3 h-6 sm:h-8 leading-tight text-gray-500 border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:border-none mr-1 dark:bg-extradarkGrey bg-lightGrey border-none">3</a>
            </li>
            <li>
              <a href="#"
                class="flex items-center justify-center px-1 sm:px-3 h-6 sm:h-8 leading-tight text-gray-500 border border-gray-300 hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white mr-1 dark:border-none dark:bg-extradarkGrey bg-lightGrey border-none"><img
            ...
            <li>
              <a href="#"
                class="flex items-center justify-center px-1 sm:px-3 h-6 sm:h-8 leading-tight text-gray-500 border border-gray-300 rounded-e-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white dark:border-none dark:bg-extradarkGrey bg-lightGrey border-none"><img
                  src="@/assets/images/doubleRight.png" class="h-3" /></a>
            </li>
          </ul>
        </nav>
      </div>
