<template>
  <DefaultLayout>
    ...
    <div v-else class="bg-white dark:bg-[#252626] px-6">
      <Heading />
...
const items = [
  {
    id: 1,
    name: "Web Store",
    data: "Nambre encargado",
    number: "00-0000-0000",
    email: "webstore@alrid.com",
  },
  {
    id: 2,
    name: "Tienda 1",
