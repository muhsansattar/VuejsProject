...
<template>
    <div class=" mt-2 sm:mt-6 max-w-[840px] mx-3 md:mx-6 py-2 px-3 rounded-xl bg-white dark:bg-extraGrey shadow-4 h-80 ">
        <div class="flex items-center flex-col sm:flex-row  justify-between ">
            ...
            <input class="mx-3 border-b-2  border-[#b8b4b4] bg-transparent outline-none text-black-2 dark:text-white text-[12px] "
        ...
        <div class="relative overflow-x-auto">
            <table class=" table-auto w-full overflow-x-scroll text-sm text-left rtl:text-right text-black-2 dark:text-white ">
