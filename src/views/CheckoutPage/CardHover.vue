<template>
    <div class="relative py-2 px-2 sm:px-3 w-full min-h-[210px] sm:h-full bg-white dark:bg-extraGrey rounded-xl shadow-4 overflow-hidden flex sm:justify-center group ">
      ...
      <div class="px-2 py-4 sm:absolute inset-0 sm:hidden group-hover:block text-black dark:text-white sm:dark:text-black-2 sm:text-white sm:bg-black sm:dark:bg-white sm:bg-opacity-35 sm:dark:bg-opacity-35">
        <p class="text-xs xsm:text-base sm:text-xl font-bold">Tenis Adidas Grand</p>
