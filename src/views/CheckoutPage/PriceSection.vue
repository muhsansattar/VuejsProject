  ...
  <div class="bg-white dark:bg-extraGrey shadow-4 py-2 px-3 mt-4  rounded-xl h-[95%] w-full flex flex-col justify-between">
    <div class="">
      <div class="flex items-center justify-between mb-4">
        ...
        <p class=" text-xl sm:text-4xl font-thin">$3547.00</p>
      </div>
      <div class="flex items-center justify-between mb-4">
        <p class="font-extrabold  ">Descuento</p>
        <p class="text-xl sm:text-4xl font-thin">$347.00</p>
      </div>
      <div class="flex items-center justify-between mb-4">
    ...
    <div class="">
      ...
      :class="[
        'px-1 xsm:px-2 md:w-[30%] py-2 text-sm sm:text-base xl:text-lg leading-none rounded-md focus:outline-none', 
        isClicked ? 'bg-green-700' : 'bg-[#E6E6E7]',
        isClicked ? 'dark:bg-darkRed' : 'dark:bg-textGrey'
      ]">
          Efectivo
        </button>
        <button class=" bg-[#E6E6E7] md:w-[30%] dark:bg-textGrey  px-2 py-2 text-sm sm:text-base xl:text-lg leading-none rounded-md focus:outline-none">
          Tarjeta <br>Debito
        </button>
        <button class=" bg-[#E6E6E7] md:w-[30%] dark:bg-textGrey px-1  xsm:px-2 py-2 text-sm sm:text-base xl:text-lg leading-none rounded-md focus:outline-none">
          tarjita <br> Credito
        </button>
      </div>
      ...
      <div class="flex justify-center mt-5 ">
        <button
          class=" bg-textGrey dark:bg-extradarkGrey px-4 sm:px-10 pt-1 pb-2 text-center text-white text-xl sm:text-3xl font-thin rounded-full focus:outline-none">
          procesar
        </button>
      </div>
    </div>
